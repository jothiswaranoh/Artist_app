...
const BrowseArtistsPage: React.FC = () => {
    ...
    const { artistProfiles, meta, isLoading, error } = useArtistProfiles(
      page,
      PER_PAGE,
      searchQuery || "",
    );
                ...
                >
                  ...
                  {artist.services && artist.services.length > 0 && (
                    <div className="customer-services-list">
                      <p className="customer-services-title">
                        Available Services
                      </p>
                      {artist.services.map((service: any) => (
                        <div key={service.id} className="customer-service-item">
                          <div className="customer-service-info">
                            ...
                            {service.description && (
                              <p className="customer-service-desc">
                                {service.description}
                              </p>
                            )}
                          </div>
            ...
            >
              ...
              >
                ...
                <div className="artist-modal-body">
                  ...
                  >
                    <div
                      className={`artist-avatar ${getAvatarGradient(selectedArtist.id)}`}
                    >
                  ...
                  <div className="artist-detail-row">
                    ...
                    <span className="detail-value">
                      {selectedArtist.experience_years || 0} years
                    </span>
                  </div>
                  <div className="artist-detail-row">
                  ...
                  <div className="artist-detail-row">
                    ...
                    <span
                      className={`approval-badge ${selectedArtist.is_approved ? "approved" : "pending"}`}
                    >
                ...
                <div className="artist-modal-body">
                  ...
                  <div className="booking-form">
                    ...
                    >
                      <div className="booking-field">
                        <label>
                          Start Time <span style={{ color: "#f87171" }}>*</span>
                        </label>
                        <input
                          type="time"
